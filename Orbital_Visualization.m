...
%%%%%%%%%%%%%%%%%
alt = 700; % [km]
%INITIAL POSITION VECTOR (in km) -From center of the earth (rad = 6371.0 km)
r= [6371+alt 0 0];
...
% Final value of time is the rate compared to real time   
    k=k+1;
...
set(gcf,'Menubar','none','Name','Earth Track', ... 
    'NumberTitle','off','Position',[250,250,1000,500]); 
hold on
